...
const MiniCart = () => {
  ...
  return (
    <section
      className=" w-screen h-screen bg-black bg-opacity-50 fixed top-0 left-0 z-30 flex justify-end"
      ref={miniCartContainer}
      onClick={handleClick}
    >
      <div className="w-5/6 lg:w-96 bg-white p-2 lg:p-6 rounded animate-in">
